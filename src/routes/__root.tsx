...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Obras Control" },
      { name: "application-name", content: "Obras Control" },
      { name: "description", content: "Gestão de obras, equipes e alocações." },
      { property: "og:title", content: "Obras Control" },
      { property: "og:description", content: "Gestão de obras, equipes e alocações." },
